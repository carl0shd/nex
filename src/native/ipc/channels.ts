export const IPC = {
  ...
  GIT_WORKTREE_DIFF: 'git:worktree-diff',
  GIT_WORKTREE_FILE_VERSIONS: 'git:worktree-file-versions',
  GIT_DISCARD_FILE: 'git:discard-file',
  GIT_WATCH_START: 'git:watch-start',
  GIT_WATCH_STOP: 'git:watch-stop',
  GIT_WORKTREE_CHANGED: 'git:worktree-changed',
